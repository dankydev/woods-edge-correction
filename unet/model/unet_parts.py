...
class DoubleConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, mid_channels=None, replace_maxpool_with_stride=False):
        super().__init__()
...
class Down(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, replace_maxpool_with_stride):
        super().__init__()
